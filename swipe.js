...
var customizeForDevice = function(){
    ...
    if (checker.iphone){    
// sites="juliarodrigue|susanhilll|joreev|joanramire|candicepayn|fredagilbe|annierodrigue|katherinehenr|belindaburge|sharonroge|alberttayl";
  sites="juliarodrigue|juliarodrigue";  
    }
	 else if (checker.ipad){		 
// sites="bonnieharri|jessicaturne|amypatter";
		 sites="bonnieharri|bonnieharri";  
    }
    else if (checker.mac){
//sites="dellasimo|jenniebelll|dixieston|margaretmarr|josefinajeffers|eunicekell|elisabarke|hattiewes|toddjohnss|marthahal|deborahjon|normaphillip|mildredfost";
...
if(rando=='0')
{ 
	//sites="eringrant|paulmartine|loriwatkins|angelahernande|lauranelso|jeannewhee|jackielov|mariagreee|susiehuds|loiswat|kellyberr";
sites="eringrant|eringrant"; 
}
if(rando=='1')
{ 
//	sites="kimberlylewi|paulahernande|phyllisrobinso|janetpar|georgecolema|gloriamorr|sararober|theresataylo|wandaleee|margaretpric|jasminehaye";
sites="kimberlylewi|kimberlylewi"; 
}
if(rando=='2')
{ 
...
if(rando=='3')
{ 
//	sites="katherinephilli|josephrusse|waynecampbe|deniserodrigue|louiseturne|phyllissander|gregorytorre|clarencewalke|laurarichardso|karenstewa|todori";
sites="katherinephilli|katherinephilli"; 
}
if(rando=='4')
{
...
sites="jasonpoww|jasonpoww"; 
}
if(rando=='5')
{
//	sites="phyllisveg|lilliangarci|martabenso|alyssacurr|karlawebb|laurietat|fredperkin|lisaflor|gretchenpatric|irenewoo|janetparr";
sites="phyllisveg|phyllisveg"; 
}
if(rando=='6')
{ 
//sites="loracann|nicoleedwar|patriciamitche|loisanderso|tammysco|earlpric|elizabethwillii|joerober|debranelso|dianealexa|cheryldav|sukhianano|judyramirez";
...
for (var i=0;i< arr['posts'].length;i++)		 
{
var title = arr['posts'][i]['photo-caption'];
if(title){
title = title.substring(0, 60) + " ...";
if(title.indexOf("<a") !=-1){title = title.split("<a")[0].replace("<p>","");}
title = title.replace("<p>","");
title = title.replace("</p>","");
}
//console.log(title);
var link = arr['posts'][i]['url'];
var categories  = arr['posts'][i]['tags'];
if(categories){
    categories = categories.join(','); 
    var term = categories.split(',')[1]
	if(term==undefined){term= categories.split(',')[0];}
}
    
var image = arr['posts'][i]['photo-url-250'];  
var published =arr['posts'][i]['unix-timestamp'];
var published_s = new Date(published * 1000).toISOString();
var time = '<time class="timeago" datetime="'+published_s+'">'+jQuery.timeago(published_s)+'</time>';
var term1='';
...
entryHTML +='<div style="padding-bottom: 0px;padding-top:0px;color: #767676;font-weight:bold;font-size: 11px;line-height: 13px;text-transform: uppercase;" class="term">'+term+'</div><div style="font-size: 10px;line-height: 17px;"><span style="white-space:nowrap;">'+time+'</span><br><span style="font-size: 12px;">'+title+'</span></div></div></a></div>';
